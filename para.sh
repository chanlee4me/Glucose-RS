...
OUTPUT_DIR="/home/wgf/chenli/SAT/modify1-glucose-4.2.1"
CADICAL_PATH="/home/wgf/chenli/SAT/modify1-glucose-4.2.1/simp/glucose"
...
process_file() {
    ...
    # 提取process-time所在行
    grep "CPU time" "$output_file" >> "$temp_file"
